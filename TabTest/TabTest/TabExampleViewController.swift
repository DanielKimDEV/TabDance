...
//import TabDance
//
//class TabDanceExampleViewController: TabDanceViewController {
//
//    var isReload = false
//
...
//
//    override func viewControllers(for pagerTabStripController: TabDanceViewController) -> [UIViewController] {
