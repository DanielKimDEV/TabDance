//
//  BasePagerStripViewController.swift
//  TabTest
//
//  Created by Daniel Kim on 2020/02/27.
...
// MARK: Protocols
 ...
 protocol PagerTabStripDataSource: class {
    ...
    func viewControllers(for pagerTabStripController: BasePagerTabStripViewController) -> [UIViewController]
}

// MARK: PagerTabStripViewController

class BasePagerTabStripViewController: UIViewController, UIScrollViewDelegate {
