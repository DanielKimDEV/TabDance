...
public enum UnderLineBarAlignment {
    case top
    case bottom
}
...
open class PagerBarView: UICollectionView {
    
    open var underLineColor:UIColor = UIColor.gray.withAlphaComponent(0.3)
    ...
    open lazy var underLineView: UIView = { [unowned self] in
